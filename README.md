...
Die aktuellste Version kann von der GitHub Releases-Seite heruntergeladen werden:

https://github.com/FrederikFinckh/auftragsmanagement/releases

Dort die gewünschte Version wählen und die Datei **Auftragsmanager-*.jar** herunterladen.

## Programm starten

1. Die heruntergeladene JAR-Datei in einen beliebigen Ordner kopieren.
2. Ein Terminal öffnen.
3. In den Ordner wechseln, in dem die JAR-Datei liegt.
4. Folgenden Befehl eingeben und mit Enter bestätigen:

```
java -jar Auftragsmanager-*.jar
```
